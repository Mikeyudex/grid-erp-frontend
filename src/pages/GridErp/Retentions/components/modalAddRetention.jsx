...
const ModalAddRetention = ({ isOpen, closeModal, handleReload }) => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            setIsLoading(true);
            await helper.createRetention(formData);
            handleCloseModal();
    ...
    return (
        <Modal
            ...
            size='lg'
        >
            <ModalHeader toggle={handleCloseModal}>{'Crear nueva retención'}</ModalHeader>
            <ModalBody>
                {"Ingresa los datos de la nueva retención"}
...
export default ModalAddRetention;
