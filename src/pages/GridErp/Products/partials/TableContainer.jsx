    ...
    <Fragment>
      ...
      <Row className="align-items-center mt-2 g-3 text-center text-sm-start">
        <div className="col-sm">
          <div className="text-muted">Mostrando<span className="fw-semibold ms-1">{getState().pagination.pageSize}</span> de <span className="fw-semibold">{data.length}</span> Resultados
          </div>
        </div>
