...
const subCategoryHelper = new SubCategoryHelper();

export function TableContainerListSubCategories({
    columns,
    isLoadingTable,
   ...
   /*  const handleSaveRow = async ({
        ...
        const newValidationErrors = categoryHelper.validateProduct(values);
